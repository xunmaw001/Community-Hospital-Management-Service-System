    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="诊断内容" prop="zhenduanneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhenduanneirong" label="诊断内容" prop="zhenduanneirong">
                    <span>{{ruleForm.zhenduanneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="诊断意见" prop="zhenduanyijian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="诊断意见"
                  v-model="ruleForm.zhenduanyijian" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhenduanyijian" label="诊断意见" prop="zhenduanyijian">
                    <span>{{ruleForm.zhenduanyijian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="病历描述" prop="binglimiaoshu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.binglimiaoshu" label="病历描述" prop="binglimiaoshu">
                    <span>{{ruleForm.binglimiaoshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="注意事项" prop="zhuyishixiang">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhuyishixiang" label="注意事项" prop="zhuyishixiang">
                    <span v-html="ruleForm.zhuyishixiang"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhenduanjieguo = true;
          ...
          if(o=='zhenduanyijian'){
            this.ruleForm.zhenduanyijian = obj[o];
	    this.ro.zhenduanyijian = true;
            continue;
          }
          if(o=='binglimiaoshu'){
	...
	this.ruleForm.zhuyishixiang = this.ruleForm.zhuyishixiang.replace(reg,'../../../springboot95an6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
