    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="诊疗方案" prop="zhenliaofangan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="诊疗方案"
                  v-model="ruleForm.zhenliaofangan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhenliaofangan" label="诊疗方案" prop="zhenliaofangan">
                    <span>{{ruleForm.zhenliaofangan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="诊疗详情" prop="zhenliaoxiangqing">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="诊疗详情"
                  v-model="ruleForm.zhenliaoxiangqing" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhenliaoxiangqing" label="诊疗详情" prop="zhenliaoxiangqing">
                    <span>{{ruleForm.zhenliaoxiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	dengjishijian : false,
	zhenliaofangan : false,
	zhenliaoxiangqing : false,
      },
      ruleForm: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dengjishijian = true;
          ...
          if(o=='zhenliaofangan'){
            this.ruleForm.zhenliaofangan = obj[o];
	    this.ro.zhenliaofangan = true;
            continue;
          }
          if(o=='zhenliaoxiangqing'){
            this.ruleForm.zhenliaoxiangqing = obj[o];
	    this.ro.zhenliaoxiangqing = true;
            continue;
          }
        }
      }
