    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="档案信息" prop="danganxinxi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="档案信息"
                  v-model="ruleForm.danganxinxi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.danganxinxi" label="档案信息" prop="danganxinxi">
                    <span>{{ruleForm.danganxinxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhuyuanjilu = true;
          ...
          if(o=='danganxinxi'){
            this.ruleForm.danganxinxi = obj[o];
	    this.ro.danganxinxi = true;
            continue;
          }
          if(o=='dengjishijian'){
