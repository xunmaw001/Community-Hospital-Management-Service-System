        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('yuyueyisheng','就诊') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="jiuzhenxinxiCrossAddOrUpdateHandler(scope.row,'cross','否','','')">{{ contents.tableBtnFont == 1?'就诊':'' }}</el-button>
                <el-button v-if="isAuth('yuyueyisheng','就诊') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="jiuzhenxinxiCrossAddOrUpdateHandler(scope.row,'cross','否','','')">{{ contents.tableBtnFont == 1?'就诊':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yuyueyisheng','就诊') && contents.tableBtnIcon == 0" type="success" size="mini" @click="jiuzhenxinxiCrossAddOrUpdateHandler(scope.row,'cross','否','','')">{{ contents.tableBtnFont == 1?'就诊':'' }}</el-button>
