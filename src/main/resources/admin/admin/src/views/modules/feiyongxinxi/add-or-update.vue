<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="收费编号" prop="shoufeibianhao">
            <el-input v-model="ruleForm.shoufeibianhao" 
                placeholder="收费编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shoufeibianhao" label="收费编号" prop="shoufeibianhao">
              <el-input v-model="ruleForm.shoufeibianhao" 
                placeholder="收费编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医疗费用" prop="yiliaofeiyong">
          <el-input v-model="ruleForm.yiliaofeiyong" 
              placeholder="医疗费用" clearable  :readonly="ro.yiliaofeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医疗费用" prop="yiliaofeiyong">
              <el-input v-model="ruleForm.yiliaofeiyong" 
                placeholder="医疗费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="医保折算" prop="yibaozhesuan">
          <el-select :disabled="ro.yibaozhesuan" v-model="ruleForm.yibaozhesuan" placeholder="请选择医保折算">
            <el-option
                v-for="(item,index) in yibaozhesuanOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="医保折算" prop="yibaozhesuan">
	      <el-input v-model="ruleForm.yibaozhesuan"
                placeholder="医保折算" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="支付费用" prop="zhifufeiyong">
            <el-input v-model="zhifufeiyong"
                placeholder="支付费用" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhifufeiyong" label="支付费用" prop="zhifufeiyong">
              <el-input v-model="ruleForm.zhifufeiyong" 
                placeholder="支付费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  data() {
	...
	ispay : false,
      ...
      rules: {
          ...
          yiliaofeiyong: [
                { required: true, message: '医疗费用不能为空', trigger: 'blur' },
  ...
  computed: {
    zhifufeiyong:{
      get: function () {
        return 1*this.ruleForm.yiliaofeiyong*this.ruleForm.yibaozhesuan
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='shoufeibianhao'){
            this.ruleForm.shoufeibianhao = obj[o];
	    this.ro.shoufeibianhao = true;
            continue;
          }
          if(o=='yonghuzhanghao'){
	    ...
	    this.ro.yiliaofeiyong = true;
          ...
          if(o=='yibaozhesuan'){
            this.ruleForm.yibaozhesuan = obj[o];
	    this.ro.yibaozhesuan = true;
            continue;
          }
          if(o=='zhifufeiyong'){
            this.ruleForm.zhifufeiyong = obj[o];
	    this.ro.zhifufeiyong = true;
            continue;
          }
          if(o=='dengjishijian'){
      ...
      this.$http({
		...
		if(json.yishengxingming!=''&&json.yishengxingming){
          ...
          this.$message.error(data.msg);
            ...
            this.yibaozhesuanOptions = "1,0.6,0.5".split(',')
    },
    // 下二随
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../springboot95an6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    // 提交
    onSubmit() {
        this.ruleForm.zhifufeiyong = this.zhifufeiyong
