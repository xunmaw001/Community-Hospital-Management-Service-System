<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医生电话" prop="yishengdianhua">
          <el-input v-model="ruleForm.yishengdianhua" 
              placeholder="医生电话" clearable  :readonly="ro.yishengdianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医生电话" prop="yishengdianhua">
              <el-input v-model="ruleForm.yishengdianhua" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.jianjie = this.ruleForm.jianjie.replace(reg,'../../../springboot95an6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
