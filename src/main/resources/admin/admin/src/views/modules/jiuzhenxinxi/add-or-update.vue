<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药物过敏史" prop="yaowuguominshi">
          <el-input v-model="ruleForm.yaowuguominshi" 
              placeholder="药物过敏史" clearable  :readonly="ro.yaowuguominshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="药物过敏史" prop="yaowuguominshi">
              <el-input v-model="ruleForm.yaowuguominshi" 
                placeholder="药物过敏史" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="现病史" prop="xianbingshi">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xianbingshi" label="现病史" prop="xianbingshi">
                    <span>{{ruleForm.xianbingshi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="处理意见" prop="chuliyijian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="处理意见"
                  v-model="ruleForm.chuliyijian" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chuliyijian" label="处理意见" prop="chuliyijian">
                    <span>{{ruleForm.chuliyijian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="门诊记录" prop="menzhenjilu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="门诊记录"
                  v-model="ruleForm.menzhenjilu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.menzhenjilu" label="门诊记录" prop="menzhenjilu">
                    <span>{{ruleForm.menzhenjilu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chubuzhenduan = true;
          ...
          if(o=='chuliyijian'){
            this.ruleForm.chuliyijian = obj[o];
	    this.ro.chuliyijian = true;
            continue;
          }
          if(o=='menzhenjilu'){
            this.ruleForm.menzhenjilu = obj[o];
	    this.ro.menzhenjilu = true;
            continue;
          }
        }
      }
